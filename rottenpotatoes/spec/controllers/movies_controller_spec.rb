...
describe MoviesController do
    ...
    let!(:movie4) {Movie.create(id: 4, title: "test", director: "George Lucas")}

    describe 'GET similar' do
        it 'movie has direcotr, should' do
            get :director_movies, id: movie1[:id]
            expect(response).to render_template(:director_movies)
        end

        it 'movie has no direcor, should' do
            get :director_movies, id: movie3[:id]
